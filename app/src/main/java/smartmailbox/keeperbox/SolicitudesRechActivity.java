...
public class SolicitudesRechActivity extends Fragment implements Request{

    String NFC;

    public SolicitudesRechActivity(String NFC){
        this.NFC = NFC;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            json.put("tipo_solicitud", "3");
        } catch (JSONException e) {
            e.printStackTrace();
        }

        Peticion peticion = new Peticion(SolicitudesRechActivity.this);
