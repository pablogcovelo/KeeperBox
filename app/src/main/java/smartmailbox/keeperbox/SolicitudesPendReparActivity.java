...
public class SolicitudesPendReparActivity extends Fragment implements Request{

    String NFC;

    public SolicitudesPendReparActivity(String NFC){
        this.NFC = NFC;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            json.put("tipo_solicitud", "2");
        } catch (JSONException e) {
            e.printStackTrace();
        }

        Peticion peticion = new Peticion(SolicitudesPendReparActivity.this);
